...
public interface IPathDAO extends IGenericDAO<Path> {
	...
	@Select("Select path.*, "
			+ "p_from.id as p_from_id, p_from.street as p_from_street, p_from.number as p_from_number, p_from.point_number as p_from_point_number, p_from.city_id as p_from_city_id, "
			+ "p_to.id as p_to_id, p_to.street as p_to_street, p_to.number as p_to_number, p_to.point_number as p_to_point_number, p_to.city_id as p_to_city_id, "
			...
			+ "coun_from.id as coun_from_id, coun_from.name as coun_from_name, "
			+ "coun_to.id as coun_to_id, coun_to.name as coun_to_name, "
